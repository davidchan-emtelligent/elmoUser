...
print (len(tokenized_context),tokenized_context)
print (context_ids.shape,context_ids[0].shape,context_ids[1].shape, context_ids[0][0].shape, context_ids[0][1],context_ids) #line:0,char:1(char:0 = <S>)
print (len(elmo_context_input_), len(elmo_context_input_[0]),len(elmo_context_input_[1]),elmo_context_input_)
